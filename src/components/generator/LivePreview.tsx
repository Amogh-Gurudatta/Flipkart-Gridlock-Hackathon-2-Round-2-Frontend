    ...
    <div className="w-full h-full flex items-start justify-center p-4">
      ...
      >
        ...
        <div className="relative z-10 flex-1 flex flex-col h-full overflow-hidden gap-[4%]">
          ...
          <div className="pb-[4%]" style={{ borderBottom: '2px solid #1e3a5f' }}>
            <div className="flex items-center justify-center gap-[2%] mb-[3%]">
              ...
              <div className="text-center">
                <div className="font-mono font-bold uppercase tracking-[0.2em]" style={{ color: '#e2e8f0', fontSize: '1em' }}>
                  BENGALURU TRAFFIC POLICE
                </div>
                <div className="font-mono uppercase tracking-[0.35em]" style={{ color: '#3b82f6', fontSize: '0.65em' }}>
                  COMMAND CENTER
                </div>
              </div>
            </div>
          ...
          {/* ── Event Details ─────────────────────────────────────────────── */}
          <div className="p-[4%]" style={{ backgroundColor: '#080f1e', border: '1px solid #1e3a5f' }}>
            ...
            <div className="flex flex-col gap-[0.9em]">
              ...
              <Row
                label="Est. Duration"
                value={forecast ? `${Math.round(forecast.predictions.estimated_duration_mins)} minutes` : '—'}
              />

              {/* Severity */}
              <div className="flex justify-between items-center">
                <span className="uppercase font-mono tracking-widest" style={{ color: '#475569', fontSize: '0.68em' }}>
                  Severity Level:
                </span>
                <span
          ...
          >
            ...
            <div className="flex flex-col gap-[0.9em]">
              ...
              <Row
                label="Barricades"
                value={forecast ? `${forecast.deployment_recommendation.barricades} units` : '—'}
              />
              <Row
                label="Cranes"
                value={forecast ? `${forecast.deployment_recommendation.cranes} units` : '—'}
              />
          ...
          <div
            ...
            style={{ borderTop: '1px solid #1e3a5f', color: '#334155', fontSize: '0.6em' }}
          >
